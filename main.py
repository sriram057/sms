...
def login():
    ...
    elif usernameEntry.get() == 'sriram' and passwordEntry.get() == '1234':
...
backgroundImage = ImageTk.PhotoImage(file='sr.jpg')

bgLabel = Label(window, image=backgroundImage)
bgLabel.place(x=2, y=2)

loginFrame = Frame(window,bg='snow3')
...
usernameLabel = Label(loginFrame, image=usernameImage, text='Username', compound=LEFT
                      , font=('times new roman', 20, 'bold'), bg='honeydew2')
